...
class EjsSiteBuilder {
    ...
    /// -----------------------------------------------------------------------------
    renderTemplate(template, path, data, overrideExtension) {
        ...
        try {
            ...
            const p = path_1.default.resolve(writePath + "/index." + ext);
                        ...
                        if (pathStars > 1) {
                            ...
                            if (pages.length === 0) {
                                ...
                                pages.forEach((generatePageRequest) => {
                                    ...
                                    rendered++;
                                    try {
                                        const fixedPath = me.renderTemplate(generateData.name, starReplacedPath, data, generatePageRequest.ext);
