...
exports.Templer = exports.TriggerReason = exports.POST_GENERATE_NAME = exports.PRE_GENERATE_NAME = exports.POST_GENERATE_JS = exports.PRE_GENERATE_JS = void 0;
...
class Templer {
            ...
            for (const itemName in cacheGroup) {
                ...
                if (expires) {
                    if (!isNaN(expires)) {
                        ...
                        if (now > expires) {
                            log(picocolors_1.default.green("Expired " + cacheName + " cache item: " + itemName));
                            delete cacheGroup[itemName];
                        }
                    }
                    else {
                        throw new Error(cacheName + " cache item " + itemName + " expires date is invalid");
                    }
                }
            }
        }
    ...
    generatePages() {
        ...
        return new Promise(function (resolve, _) {
            ...
            const checkDone = (pageName, generated = false, outPath = "") => {
            ...
            toGenerate.forEach((generateData) => {
                ...
                if (me.getGenerateScript(generateData.name)) {
                    ...
                    const code = "((require, resolve, reject, generate, inputs, getDataFileNames, cache, log, frontMatterParse, dataDir, renderTemplate) =>  {" +
                    ...
                    try {
                        ...
                        inputs, me.getDataFileNames.bind(me, generateData.name), me.state.cache[me.getCacheName(generateData.name)], me.scriptLogger.bind(null, generateData.name), front_matter_1.default, path_1.default.resolve(me.dataDir), renderTemplate);
                    }
                    catch (error) {
                        me.state.errorCount++;
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (fs_1.default.existsSync(g)) {
                ...
                const generateSuccess = (response) => {
                    ...
                    me.processGeneratorResponse(response, exports.PRE_GENERATE_JS, me.getCacheName(exports.PRE_GENERATE_NAME));
                    resolve();
                };
                const generateError = (error) => {
                    pinger.stop();
                ...
                if (!me.state.cache[me.getCacheName(exports.PRE_GENERATE_NAME)]) {
                    me.state.cache[me.getCacheName(exports.PRE_GENERATE_NAME)] = {};
                }
                const code = "((require, resolve, reject, cache, log, dataDir) =>  {" +
                    script +
                    "})";
                try {
                    vm_1.default.runInThisContext(code)(require, generateSuccess, generateError, me.state.cache[me.getCacheName(exports.PRE_GENERATE_NAME)], me.scriptLogger.bind(null, exports.PRE_GENERATE_NAME), path_1.default.resolve(me.dataDir));
                }
                catch (error) {
                    me.state.errorCount++;
                    logError(error);
                ...
                log(picocolors_1.default.blue(exports.PRE_GENERATE_JS + " not found, skipping."));
    ...
    processPostGenerate() {
        ...
        return new Promise(function (resolve, reject) {
            ...
            if (fs_1.default.existsSync(g)) {
                ...
                const generateSuccess = (response) => {
                    pinger.stop();
                    me.processGeneratorResponse(response, exports.POST_GENERATE_JS, me.getCacheName(exports.POST_GENERATE_NAME));
                    resolve();
                };
                const generateError = (error) => {
                    me.state.errorCount++;
                ...
                const script = fs_1.default.readFileSync(g, "utf8");
                if (!me.state.cache[me.getCacheName(exports.POST_GENERATE_NAME)]) {
                    me.state.cache[me.getCacheName(exports.POST_GENERATE_NAME)] = {};
                }
                const code = "((require, resolve, reject, cache, output, log, dataDir) =>  {" +
                    script +
                    "})";
                try {
                    vm_1.default.runInThisContext(code)(require, generateSuccess, generateError, me.state.cache[me.getCacheName(exports.POST_GENERATE_NAME)], me.state.outputData, me.scriptLogger.bind(null, exports.POST_GENERATE_NAME), path_1.default.resolve(me.dataDir));
                }
                catch (error) {
                    me.state.errorCount++;
                    logError(error);
                ...
                log(picocolors_1.default.blue(exports.POST_GENERATE_JS + " not found, skipping."));
                resolve(); // no global data
            }
        });
    }
    ...
    /// -----------------------------------------------------------------------------
    getGlobalDeps() {
        console.log(picocolors_1.default.green("Update Triggered by preGenerate.js change."));
        return this.state.globalDeps;
    }
}
exports.Templer = Templer;
