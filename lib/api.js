...
exports.Templer = exports.TriggerReason = void 0;
        ...
        return new Promise(async function (resolve, _) {
            ...
            func(generatePage,inputs,getDataFileNames, cache, log, frontMatterParse, dataDir, renderTemplate).then(result=>resolve(result)).catch((error)=>reject(error));
                        ...
                        try {
                            ...
                            inputs, me.getDataFileNames.bind(me, generateData.name), me.state.cacheData, me.scriptLogger.bind(null, generateData.name), front_matter_1.default, path_1.default.resolve(me.dataDir), renderTemplate);
                        }
                        catch (error) {
                            me.state.errorCount++;
            ...
            await Promise.all(toGenerate.map((generateData) => {
