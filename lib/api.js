...
class AirFry {
    ...
    renderTemplate(template, path, data) {
        ...
        return new Promise(function (resolve, reject) {
            try {
                const renderInclude = function (wrapStack, // stack of wrappers
                ...
                includeData // passed with ejs include
                    ...
                    return me.state.templates[current](renderData, undefined, renderInclude.bind(null, wrapStack, renderData));
                };
                ...
                const html = me.state.templates[wrapper](renderData, undefined, renderInclude.bind(null, wrapStack, renderData));
                    ...
                    const generateDone = (response) => {
                        ...
                        if (rendered == 0) {
                            ...
                            const pathStars = (generateData.generate.match(/\*/g) || [])
                                .length;
                            if (pathStars > 0) {
                                throw new Error("If no page requests are made, the generate path of the template must be defined without a * " +
                                    generateData.name);
                            }
