...
console.log(chalk_1.default.blueBright("Version " + version_1.LIB_VERSION + "\n"));
...
program.version(version_1.LIB_VERSION);
...
const airfry = new api_1.AirFry(inputDir, dataDir, outputDir, cacheDir);
